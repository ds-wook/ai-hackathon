...
from tuning.bayesian import BayesianOptimizer, cat_objective
...
def _main(cfg: DictConfig):
    ...
    objective = partial(cat_objective, X=X, y=y, n_fold=cfg.model.fold)
    bayesian_optim = BayesianOptimizer(objective)
    study = bayesian_optim.build_study(trials=cfg.optimization.trials)
    bayesian_optim.cat_save_params(study, cfg.optimization.params)
