...
from tuning.bayesian import BayesianOptimizer, oof_objective


@hydra.main(config_path="../../config/optimization/", config_name="ensemble.yaml")
def _main(cfg: DictConfig):
    ...
    objective = partial(
        oof_objective,
        model1_oof=model1_oof,
        model2_oof=model2_oof,
        model3_oof=model3_oof,
        model4_oof=model4_oof,
        cnn_oof=cnn_oof,
        automl_oof=auto_oof,
        y=y,
    )
    ...
    bayesian_optim.display_study_statistics(study)
